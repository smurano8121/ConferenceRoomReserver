    ...
    function checkFreeBusy(auth,registData){
        ...
        calendar.freebusy.query({
            ...
            if (events.length == 0) {
                ...
                res.json({ "fulfillmentText": date.toFormat('YYYY年MM月DD日')+"の"+events[0].start.toFormat('HH24時MI分')+"から"+events[0].end.toFormat('HH24時MI分')+"はすでに予約されています．別の時間帯もしくは別の会議室を予約してください" });
            }   
        });
    }
});
